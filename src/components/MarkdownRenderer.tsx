        ...
        components={{
          ...
          img: ({ className: imageClassName, alt, ...props }) => (
            <img
              ...
              alt={alt ?? ""}
              className={cn(
                "my-3 max-h-[26rem] w-auto max-w-full rounded-xl border border-border/60 bg-background object-contain",
                imageClassName,
              )}
            />
          ),
          ...
          ul: ({ className: listClassName, ...props }) => (
            <ul {...props} className={cn("list-disc space-y-1 pl-5", listClassName)} />
          ),
